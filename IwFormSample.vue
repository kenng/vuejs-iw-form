...
const formTextName: IwFormConfig = new IwFormConfig({
    formData: {
...
const formAutoComplete: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            name: 'food',
            label: 'Food',
...
const formRadioBtn: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            name: 'radioBtn',
...
const formRadioBtnInlineDisabled: IwFormConfig = new IwFormConfig({
    formData: {
...
const formCheckBoxSimple: IwFormConfig = new IwFormConfig({
    formData: {
        result: 1,
    },
    formInputs: [
...
const formCheckBoxCustomValue: IwFormConfig = new IwFormConfig({
    formData: {
        resultFail: 'failed',
    },
    formInputs: [
...
const formDateAfter: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            name: 'dateMin',
            type: IwFormType.DATE,
...
const formDateMax: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            name: 'dateMax',
            type: IwFormType.DATE,
...
const formDateBetween: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            name: 'dateBetween',
            type: IwFormType.DATE,
...
const formDateCustomFunction: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            name: 'dateCustomFn',
            type: IwFormType.DATE,
...
const formSingleUpload: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            name: 'uploader',
...
const formMultipleUpload: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            name: 'uploader',
            type: IwFormType.UPLOADER,
...
const formTime: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            name: 'time',
            type: IwFormType.TIME,
...
const formTextMoreAttribute: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
...
const formSwitch: IwFormConfig = new IwFormConfig({
    formData: {
...
const formSwitchWithPropData: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
...
const gridForm: IwFormConfig = new IwFormConfig({
    formInputs: [
        {
            type: IwFormType.TEXTGROUP_TEXT,
            name: 'name1',
